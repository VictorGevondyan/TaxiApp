...
//        // Attach View.OnTouchListener
        actionbar.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                return SideMenuLayout.this.onContentTouch(v, event);
            }
        });
    ...
    private MenuToggle handler;
    
    public void setHandler(MenuToggle handler) {
    	this.handler = handler;
    }
    
    public interface MenuToggle {
    	public void onMenuToggling();
